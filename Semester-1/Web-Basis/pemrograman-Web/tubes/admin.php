...
<!DOCTYPE html>
    ...
    <body class="clinic_version">
        <header>
            ...
            <div id="price" class="section pr wow fadeIn" style="background-image:url('images/price-bg.png'); padding-top:250px;">
            <div class="container">
                <div class="row">
                <div class="col-md-12">
                        ...
                        <div class="tab-pane active fade in" id="tab1">
                            ...
                            <div class="col-md-4">
                                <div class="pricing-table">
                                    ...
                                    <div class="pricing-table-sign-up">
                                        <a href="infoadmin.php" data-scroll="" class="btn btn-dark btn-radius btn-brd">Learn More</a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4">
                            ...
                            <div class="col-md-4">
                                <div class="pricing-table">
                                    ...
                                    <div class="pricing-table-sign-up">
                                        <a href="contactadmin.php" data-scroll="" class="btn btn-dark btn-radius btn-brd">Learn More</a>
                                    </div>
                                </div>
                            </div>
                            </div>
